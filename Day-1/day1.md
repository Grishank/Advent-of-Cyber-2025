...
## 🧭 Overview
Day 1 introduces the Advent of Cyber 2025 event and walks through essential skills such as navigating TryHackMe, using the AttackBox, Linux/Windows basics, Wi-Fi concepts, and small security puzzles.
...
## **📘 Task 4 — Introduction**
Explains that Day 1 will contain fun beginner challenges.  
...
Below are the 10 hands-on challenges included in Day 1.
...
# 🧠 **Key Takeaway**
> “Cybersecurity starts with curiosity — Day 1 encourages exploring, asking questions, and solving small problems that build into real skills.”
